      ...
      {isSignupFinished && (
        <div className="mb-10">
          <motion.div
            ...
            className="px-10 py-3 bg-lime-400 text-base rounded-sm shadow-sm"
          >
            <div className="font-bold">
              {dict.authPages?.accountSuccessfulyCreated}
            </div>
            <div>{dict.authPages?.youAreAllSetPleaseSignin}</div>
          </motion.div>
        </div>
      )}
