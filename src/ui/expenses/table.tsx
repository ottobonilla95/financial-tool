...
import { formatDateToLocal, formatCurrency } from "@/src/helpers/utils";
import { fetchLatestExpenses } from "@/src/data/expenses";
...
export default async function InvoicesTable({
  ...
  // const invoices = await fetchLatestExpenses(query, currentPage);
